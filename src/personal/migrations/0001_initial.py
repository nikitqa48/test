    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='default/default.jpg', null=True, upload_to=src.personal.models.user_directory_path)),
                ('job_title', models.CharField(max_length=100, verbose_name='Должность')),
                ('fio', models.CharField(blank=True, max_length=500, null=True)),
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customUser', to='department.department')),
